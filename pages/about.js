  ...
  return (
    <div className='section no-pad-bot' id='index-banner'>
      <div className='container'>
        <br />
        <br />
        <h1 className='header center orange-text'>About Template</h1>
              ...
              <div className='col s12 m4'>
                <div className='icon-block'>
                  ...
                  <p className='light'>
                    ...
                    a framework that incorporates components and animations that provide more
                    feedback to users. Additionally, a single underlying responsive system across
